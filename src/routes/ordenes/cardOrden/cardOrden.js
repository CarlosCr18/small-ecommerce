    ...
    <div className={styles.cardOrdenContainer}>
      ...
      <div className={styles.gridContainer}>
        <div className={styles.gridElementWelcome}>
          Hello user <strong>{orden.user_id}</strong>. This is your order ID: <strong>{orden.id}</strong>
        </div>
        <hr></hr>
        <div className={styles.gridElementInfo}>
          ...
          <div className={styles.gridElement}>
            ...
            <p>
              {" "}
              <strong>${orden.subtotal.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</strong>
            </p>
          </div>
          <div className={styles.gridElement}>
            <p>Discount</p>
            <p>
              {" "}
              <strong>${orden.discount.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</strong>
            </p>
          </div>
          <div className={styles.gridElement}>
            <p>Total</p>
            <p>
              {" "}
              <strong>${orden.total.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}</strong>
            </p>
          </div>
          <hr></hr>
