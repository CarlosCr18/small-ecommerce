...
const ListaDeOrdenes = () => {
  ...
  const [buscarDetallesHook, { data: detallesDeOrden }] = api.useGetOrderDetailMutation();
  ...
  if (listaDeOrdenes.response.length === 0) {
    return (
      <div className={styles.subTotalContainer}>
        ...
        <p className={styles.subTotal}>Take a look at the products list and add something to your cart</p>
        <Link to={"/"}>
          <button className={styles.btnIrAProductos}>Go to products</button>
        </Link>
      </div>
        ...
        <div className={styles.ordenActual}>
          ...
          <div className={styles.controlDeOrden}>
            ...
            <div className={styles.numeroDeOrden}>
              ...
              <p>{numeroDeOrden + 1 + " / " + listaDeOrdenes.response.length}</p>
          ...
          <CardOrden
            ...
            styles={styles}
            detallesDeOrden={detallesDeOrden && detallesFetched ? detallesDeOrden.response : []}
          />
